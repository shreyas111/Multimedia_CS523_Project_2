...
def basic_tokenizer(sentence):
  ...
  for space_separated_fragment in sentence.strip().split():
    #print('Inside For')
    line = tf.compat.as_bytes(space_separated_fragment)
    words.extend(_WORD_SPLIT.split(line))
...
def initialize_vocabulary(vocabulary_path):
  ...
  if gfile.Exists(vocabulary_path):
    ...
    #with codecs.open(vocabulary_path,'r',encoding='utf-8', errors="ignore") as f:
...
def data_to_token_ids(data_path, target_path, vocabulary_path,
  ...
  Args:
    ...
    normalize_digits: Boolean; if true, all digits are replaced by 0s.
  """
  print('Inside Data to Token ids')
  if not gfile.Exists(target_path):
    print("Tokenizing data in %s" % data_path)
    vocab, _ = initialize_vocabulary(vocabulary_path)
    with gfile.GFile(data_path, mode="rb") as data_file:
    #with codecs.open(data_path,'r',encoding='utf-8', errors="ignore") as data_file:
